...
Katib is under development and has no release yet. See `ARCHITECTURE.md` for how it works, `DESIGN.md` for how it looks, and `CLAUDE.md` for how to work in the repo.
...
Checks that must pass before a commit are listed in `CLAUDE.md`.
